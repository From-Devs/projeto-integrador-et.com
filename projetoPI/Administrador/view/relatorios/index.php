...
<body>
    ...
    <div id="container">
        ...
        <div id="geralInformacoes">
            ...
            <?php dadosInforRelatorios('receita','./../../public/iformaRelatorios/grafico.png','Relátorio de Receitas','','grafico') ?>
            <?php dadosInforRelatorios('produto','./../../public/iformaRelatorios/folha.png','Receita por Produto','folha') ?>
            <?php dadosInforRelatorios('abandonadas','./../../public/iformaRelatorios/sadFace.png','Vendas Abandonadas','sadFace') ?>
        </div>
