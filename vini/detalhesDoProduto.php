...
if ($id > 0) {
    ...
    $resultado = $produtoController->BuscarProdutoPorId($id);
...
<span>Disponível no estoque <img src="/projeto-integrador-et.com/public/imagens/popUp_Botoes/img-confirmar.png" alt="img-correto"></span>
                    ...
                    <div class="botoes-detalhes">
                        ...
                        <div>
                            <?php echo botaoPersonalizadoRedirect("Comprar agora", "btn-white", "/projeto-integrador-et.com/app/views/usuario/Meu_Carrinho.php", "100%", "40px")?>
                        </div>
                    </div>
                </div>
            </div>
