...
class ProdutoController{
    ...
    public function CadastrarProduto($nome, $marca, $breveDescricao, $preco, $precoPromocional, $caracteristicasCompleta){
        try {
            $sql = "INSERT INTO PRODUTO(nome, marca, descricaoBreve, descricaoTotal, preco, precoPromo)
            VALUES
            (:nome, :marca, :descricaoBreve, :descricaoTotal, :preco, :precoPromo)";
