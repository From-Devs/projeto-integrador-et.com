<?php 
    ...
    require __DIR__ . "/../../Controllers/AssociadosController.php";
    ...
    $dados = $associadosController->BuscarTodosAssociados($tipo_tabela, $ordem, $pesquisa);
?>
...
<body>
    ...
    <div class="main">
        <div id="container">
            ...
            <?php echo filtro("associado", ["ID", "Nome", "Cidade"])?>
            ...
            <div class="listaContainer">
                ...
                $pagina = paginarMaisDeUmaQueryString($dados, 6);
                associadosTabela($tipo_tabela, $pagina['dados']);
