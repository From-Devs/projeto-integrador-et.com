...
<?php
    ...
    // Confirmação padrão ---------------------------------------------------------------------
    $btnSim = botaoPersonalizadoRedirect("Sim", "btn-black", "et_pontocom/app/views/auth/login.php?resposta?sim", "100px");
    $btnNao = botaoPersonalizadoRedirect("Não", "btn-white", "et_pontocom/app/views/auth/login.php?resposta?nao", "100px");
    ...
    $btnVoltarTelaInicial = botaoPersonalizadoRedirect("Voltar a Tela de Inicio", "btn-white", "et_pontocom/app/views/auth/login.php?cadastro=enviado", "200px", "30px", "0.9rem");
    ...
    $btnDentroPopUp = botaoPersonalizadoRedirect("Fazer Download em PDF", "btn-black", "et_pontocom/app/views/auth/login.php?relatorio=abrir", "200px", "50px");
