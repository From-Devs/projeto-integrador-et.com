...
function tabelaPedidosADM($pedidos) {
    ...
    foreach ($pedidos as $pedido) {
        ...
        $tabela .= "<tr>
                    ...
                    <td>
                        <button class='tresPontos' onclick='abrirPopUp(\"modalDetalhesDoPedido{$contador}\")'><img src='/projeto-integrador-et.com/et_pontocom/public/imagens/imagensADM/tresPontos.png' alt='img-tresPontos'></button>
                    </td>
                </tr>";
        $contador++;
    }
