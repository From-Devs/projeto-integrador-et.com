                            ...
                            <td>
                                <div class="acoes-tabela">
                                    ...
                                    <div class="excluir" onclick="abrirPopUp('popUpExcluir')">
                                        <img src="/projeto-integrador-et.com/et_pontocom/public/imagens/associado/img-excluir.png" alt="img-excluir">
                                    </div>
                                    <div class="editar" onclick="abrirPopUp('dialog-editar')">
                                        <img src="/projeto-integrador-et.com/et_pontocom/public/imagens/associado/img-editar.png" alt="img-editar">
                                    </div>
                                </div>
                            </td>
                        </tr>
