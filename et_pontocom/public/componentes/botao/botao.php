...
function botaoPersonalizadoOnClick($texto, $tipo="btn-black", $onClick, $largura="auto", $altura="auto", $tamanhoFonte="1rem"){ 
    ...
    if(in_array($tipo, $tipos)){
        ...
        if($tipo == "btn-red"){
            return "
            <button id='botaoPadrao' class='btn $tipo' style='width: $largura; height:$altura; font-size: $tamanhoFonte;' onclick='$onClick'><img src='/projeto-integrador-et.com/et_pontocom/public/imagens/img-cancelar.png' alt='img-cancelar' class='img-cancelar'>$texto</button>";
            ...
            <img src='/projeto-integrador-et.com/et_pontocom/public/imagens/img-confirmar.png' alt='img-confirmar' class='img-confirmar'>$texto</button>";
        }else{
        ...
        if($tipo == "btn-red"){
            ...
            <button class='btn $tipo' style='width: $largura; height:$altura; font-size: $tamanhoFonte;'>
                <a class='btn-link' href='/projeto-integrador-et.com/et_pontocom/$url'>
                    <img src='/projeto-integrador-et.com/et_pontocom/public/imagens/img-cancelar.png' alt='img-cancelar' class='img-cancelar'>$texto
                </a>
            </button>";
        }else if($tipo == "btn-green"){
            return "
            <button class='btn $tipo' style='width: $largura; height:$altura; font-size: $tamanhoFonte;'>
                <a class='btn-link' href='/projeto-integrador-et.com/et_pontocom/$url'>
                    <img src='/projeto-integrador-et.com/et_pontocom/public/imagens/img-confirmar.png' alt='img-confirmar' class='img-confirmar'>$texto
                </a>
            </button>";
        }else{
