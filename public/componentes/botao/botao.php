...
function botaoPersonalizadoOnClick($texto, $tipo="btn-black", $onClick, $largura="auto", $altura="auto", $tamanhoFonte="1rem"){ 
    ...
    if(in_array($tipo, $tipos)){
        ...
        if($tipo == "btn-red"){
            ...
            <img src='/projeto-integrador-et.com/public/imagens/popUp_Botoes/img-confirmar.png' alt='img-confirmar' class='img-confirmar'>$texto</button>";
        }else{
    ...
    if(in_array($tipo, $tipos)){
        ...
        if($tipo == "btn-red"){
            ...
            <button class='btn $tipo' style='width: $largura; height:$altura; font-size: $tamanhoFonte;'>
                <a class='btn-link' href='/projeto-integrador-et.com/$url'>
                    <img src='/projeto-integrador-et.com/public/imagens/popUp_Botoes/img-cancelar.png' alt='img-cancelar' class='img-cancelar'>$texto
                </a>
            </button>";
        }else if($tipo == "btn-green"){
            return "
            <button class='btn $tipo' style='width: $largura; height:$altura; font-size: $tamanhoFonte;'>
                <a class='btn-link' href='/projeto-integrador-et.com/$url'>
                    <img src='/projeto-integrador-et.com/public/imagens/popUp_Botoes/img-confirmar.png' alt='img-confirmar' class='img-confirmar'>$texto
                </a>
            </button>";
        }else{
